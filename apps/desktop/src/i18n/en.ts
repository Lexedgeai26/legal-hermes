...
export const en: Translations = {
  ...
  install: {
    ...
    oneTimeTitle: 'LexEdge AI needs a one-time local setup',
    ...
    failedTitle: 'LexEdge AI setup failed',
    ...
    error: 'Error',
    hideOutput: 'Hide full installer output',
    showOutput: 'Show full installer output',
