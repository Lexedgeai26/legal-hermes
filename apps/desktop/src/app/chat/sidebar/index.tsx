...
import { type AppView, ARTIFACTS_ROUTE, MATTERS_ROUTE, MESSAGING_ROUTE, SKILLS_ROUTE } from '../../routes'
...
const SIDEBAR_NAV: SidebarNavItem[] = [
  ...
  { id: 'matters', label: '', icon: props => <Codicon name="folder-library" {...props} />, route: MATTERS_ROUTE },
            ...
            <SidebarMenu className="gap-px">
              {SIDEBAR_NAV.map(item => {
                ...
                const active =
                  ...
                  (item.id === 'matters' && currentView === 'matters') ||
