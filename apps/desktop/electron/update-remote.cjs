 ...
 *
 * A public install can end up with `origin=git@github.com:Lexedgeai26/legal-hermes.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/Lexedgeai26/legal-hermes.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/lexedgeai26/legal-hermes'
