...
/*
 * Success screen. LEXEDGE HERMES AGENT wordmark stays as the visual anchor
 ...
 * the desktop app doesn't exist). We catch the Tauri error and surface it
  ...
  return (
    <div className="hermes-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>LexEdge Hermes Agent is ready</span>
          </span>
          <span aria-hidden="true">LexEdge Hermes Agent is ready</span>
        </p>
      ...
      >
        <Rocket size={18} />
        {launching ? 'Launching…' : 'Launch LexEdge Hermes Agent'}
      </Button>
