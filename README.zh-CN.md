...
> **LexEdge 说明：** 此翻译保留了上游 Hermes Agent 的通用说明。LexEdge 法律版的最新功能、macOS/Windows 安装、Matter Workspaces 与 n8n 指南请以[英文主 README](README.md)、[LexEdge Agent 页面](https://lexedge.ai/agent/)和[公开仓库](https://github.com/Lexedgeai26/legal-hermes)为准。
...
- 🐛 [LexEdge 问题反馈](https://github.com/Lexedgeai26/legal-hermes/issues)
- 💡 [LexEdge 公开仓库](https://github.com/Lexedgeai26/legal-hermes)
